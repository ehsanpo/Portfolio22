...
<footer className="footer" role="contentinfo">
    <div className="grid--footer">
        <div className="col">
            <div className="col-logo" itemScope="" itemType="http://schema.org/Organization">
            ...
            <div className="social">
                <a href="https://www.facebook.com/ehsan.pourhadi.1">
                    <svg width="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path d="M200.7 512V283H124v-91h76.7v-71.7C200.7 42.4 248.3 0 317.8 0c33.3 0 61.9 2.5 70.2 3.6V85h-48.2c-37.8 0-45.1 18-45.1 44.3V192H380l-11.7 91h-73.6v229" fill="#fff"></path>
                    </svg>
                </a>
                <a href="https://www.instagram.com/ehsaanpo/">
                    <svg width="24" enableBackground="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="https://soundcloud.com/eprumental">
                    <svg width="24" enableBackground="new 0 0 512 288" viewBox="0 0 512 288" xmlns="http://www.w3.org/2000/svg">
                        <path fill="#fff" d="m432 128c-5.7 0-11.3.6-16.7 1.8-7.2-72.8-68.7-129.8-143.3-129.8-8.8 0-16 7.2-16 16v256c0 8.8 7.2 16 16 16h160c44.1 0 80-35.9 80-80s-35.9-80-80-80z"></path>
                        <path fill="#fff" d="m208 32c-8.8 0-16 7.2-16 16v224c0 8.8 7.2 16 16 16s16-7.2 16-16v-224c0-8.8-7.2-16-16-16z"></path>
                        <path fill="#fff" d="m144 96c-8.8 0-16 7.2-16 16v160c0 8.8 7.2 16 16 16s16-7.2 16-16v-160c0-8.8-7.2-16-16-16z"></path>
                        <path fill="#fff" d="m80 96c-8.8 0-16 7.2-16 16v160c0 8.8 7.2 16 16 16s16-7.2 16-16v-160c0-8.8-7.2-16-16-16z"></path>
                        <path fill="#fff" d="m16 144c-8.8 0-16 7.2-16 16v96c0 8.8 7.2 16 16 16s16-7.2 16-16v-96c0-8.8-7.2-16-16-16z"></path>
                    </svg>
                </a>
